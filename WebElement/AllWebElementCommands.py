...
newsletter_selected = driver.find_element(By.XPATH, '//*[@id="content"]/form/fieldset[3]/div/div/label[2]/input').is_selected()
print(newsletter_selected)  # True

privacy_policy_display = driver.find_element(By.NAME, "agree").is_displayed()
print(privacy_policy_display)  # True

privacy_policy_enable = driver.find_element(By.NAME, "agree").is_enabled()
print(privacy_policy_enable)   # True
"""

# Step 2: Open Opencart home page
